<div class="heading-page heading-page-1 bg-cover"
    style="background: url(images/heading-page-04.jpg) center center no-repeat;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="icon-box icon-box-5">
                    ...
                    <div class="content">
                        <h3 class="title">
                            <a href="services-v1.html">Financial Consulting</a>
                        </h3>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="icon-box icon-box-5">
                    ...
                    <div class="content">
                        <h3 class="title">
                            <a href="services-v1.html">Insurance Consulting</a>
                        </h3>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="icon-box icon-box-5">
                    ...
                    <div class="content">
                        <h3 class="title">
                            <a href="services-v1.html">Retirement Strategies</a>
                        </h3>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="icon-box icon-box-5">
                    ...
                    <div class="content">
                        <h3 class="title">
                            <a href="services-v1.html">Business Loan</a>
                        </h3>
...
<div class="section section-split bg-black">
    <div class="section-split-left bg-cover matchHeigh"
        style="background: url(&quot;images/bg-contact-form-02.jpg&quot;) center center no-repeat;"></div>
