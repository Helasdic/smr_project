...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/css/bootstrap-responsive.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ url('assets/css/style.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ url('assets/css/pluton.css') }}" />
    <!--[if IE 7]>
                            ...
                            <form id="contact-form" action="php/mail.php">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <div class="error left-align" id="err-comment">Please enter your comment.
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
